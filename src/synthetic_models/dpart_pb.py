...
class DPartPB(SyntheticModel):
    def __init__(self, epsilon=None, bounds=None, metadata=None, n_parents=2):
        self.metadata = metadata
        self.synth_model = PrivBayes(epsilon=epsilon, n_parents=n_parents)
