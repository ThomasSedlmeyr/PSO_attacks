...
class DSynthPB(SyntheticModel):
    def __init__(self, n_parents=2, tmp_dir='tmp/', epsilon=None, curr_id=None, metadata=None,version='latest', seed=None):
    ...
    def get_struct_enc(self):
        ...
        attrs = sorted([col['name'] for col in self.metadata['columns']])
        n_attrs = len(attrs)
